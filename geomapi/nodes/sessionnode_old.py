"""
**SetNode** - a Python Class to govern the data and metadata of remote sensing data captured in the same epoch.
...
#---------------------METHODS----------------------------
    ...
    def session_to_graph(self,graphPath:str|Path=None,save:bool=False) -> Graph:
        ...
        """
        if graphPath and Path(graphPath).suffix.upper() in ut.RDF_EXTENSIONS :
